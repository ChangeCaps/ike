pub use ike_input::Key;
use ike_input::MouseButton;

pub const fn element_state_pressed(element_state: winit::event::ElementState) -> bool {
    match element_state {
...
pub const fn convert_virtual_key_code(virtual_key_code: winit::event::VirtualKeyCode) -> Key {
