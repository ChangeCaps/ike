...
use glam::{EulerRot, IVec2, IVec3, IVec4, Mat2, Mat3, Mat4, Quat, UVec2, UVec3, UVec4, Vec2, Vec3, Vec4};

use crate::EguiValue;

impl EguiValue for Vec2 {
...
impl EguiValue for bool {
	fn ui(&mut self, ui: &mut egui::Ui) -> egui::Response {
		ui.checkbox(self, "")
	}
}

impl EguiValue for String {
	fn ui(&mut self, ui: &mut egui::Ui) -> egui::Response {
		ui.text_edit_multiline(self)
	}
}

impl EguiValue for PathBuf {
	fn ui(&mut self, ui: &mut egui::Ui) -> egui::Response {
